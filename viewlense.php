    ...
    <div class="details-page">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active text-uppercase"><a href="lenses.php" class="text-primary">Lenses</li></a>
          <li class="breadcrumb-item active text-uppercase"><?php echo $_REQUEST['name']; ?>-<?php echo $_REQUEST['lensename']; ?></li>
        </ol>
      </div>
      <!-- Item details -->
      <section class="item-details p-t-small p-b-small">
        <div class="container">
          <?php
          $qry="select *,l.description as description from lenses l,media m,brand b where l.media_id=m.media_id and l.brand_id=b.brand_id and lense_id=".$_REQUEST['lid'];
          ...
          <div class="row">
            ...
            <div data-slider-id="1" class="owl-carousel item-slider">
                <div class="item"> <img style="height: 400px !important;width: 400px !important;" src="../zellanto/admin/media/<?php echo $lst['media_url']; ?>" alt="lens"></div>
                <div class="item"> <img style="height: 400px !important;width: 400px !important;" src="../zellanto/admin/media/<?php echo $lst['media_url']; ?>" alt="lens"></div>
                <div class="item"> <img style="height: 400px !important;width: 400px !important;" src="../zellanto/admin/media/<?php echo $lst['media_url']; ?>" alt="lens"></div>
              </div>
        ...
        <li class="item5"><a href="#"><img src="images/arrow.png" alt="">Make A Gift</a>
          <ul>
            ...
            <div class="col-md-6">
              <h1 class="h2"><?php echo $lst['name']."-".$lst['lense_name']; ?></h1>
              ...
              <div class="model">
                <ul class="list-unstyled">
                  <li><span class="text-uppercase">Item No: </span><?php echo $lst['name']."-".$lst['lense_name']; ?></li>
                  <li><span class="text-uppercase">Filter Size: </span><?php echo $lst['filtersize']; ?></li>
                  <li><span class="text-uppercase">Max Aperature: </span><?php echo $lst['maxaperature']; ?></li>
                </ul>
              </div>
              ...
              <form action="#" method="get">
                ...
                <div class="CTAs"> 
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a href="cartsession.php?catid=<?php echo $viewcatid; ?>&lense_id=<?php echo $lst['lense_id']; ?>&adcart=1" class="add-cart item_add" class="btn btn-unique">Add To Cart</a>
                      <a href="cartsession.php?catid=<?php echo $viewcatid;?>&lense_id=<?php echo $lst['lense_id']; ?>&buy_now=1" title="Buy Now" class="add-cart item_add">BUY NOW</a>
                    </li>
                  </ul>
                </div>
              </form>
      ...
      <section class="related-items p-t-small p-b-small">
        <div class="container">
          ...
          <div class="row">
                <?php
                $qry="select * from lenses l,media m,brand b where l.media_id=m.media_id and l.brand_id=b.brand_id order by lense_id Desc limit 3";
                $result=mysqli_query($con,$qry);
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-grid5">
                        <div class="product-image5">
                                    ...
                                    <ul class="social">
                                        <li><a href="cartsession.php?catid=<?php echo $viewcatid;?>&lense_id=<?php echo $lst['lense_id']; ?>&addcart=1" title="Add to cart" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
