...
<div class="wrapper">
    <div class="fresh-table full-screen-table">
        <div align="right">
            <a href='brandform.php' class="btn btn-round btn-dark">Insert</a>
        </div>
        <?php
        $qry="select * from brand order by brand_id Desc";
        ...
        <table id="fresh-table" class="table">
            <thead>
                ...
                <th data-field="buf" data-sortable="true">Brand Used For</th>
            ...
            while($lst=mysqli_fetch_array($result))
            {
                ...
                echo "<td><a href='brandedit_form.php?bid=".$lst['brand_id']."'><i class='fa fa-edit'></i></a></td>";
                echo "<td><a href='brand_delete.php?bid=".$lst['brand_id']."'><i class='fa fa-trash'></i></a><br></td>";
                echo "</tr>";
            }
            ?>
            </tbody>
