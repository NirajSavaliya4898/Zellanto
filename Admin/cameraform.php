            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Insert Cameras</h4>
                            ...
                            <div class="content">
                                <form action="camera_insert.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="group">      
                                              <input type="text" Name="camname" required placeholder="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="group">      
                                              <input type="text" rows="5" Name="desc1" required placeholder="">
                                              <span class="highlight"></span>
                                              <span class="bar"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="group">      
                                              <input type="text" rows="5" Name="desc2" required placeholder="">
                                              <span class="highlight"></span>
                                              <span class="bar"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="group">      
                                              <input type="text" rows="5" Name="desc3" required placeholder="">
                                              <span class="highlight"></span>
                                              <span class="bar"></span>
