    ...
    <div class="contact-page">
        ...
        <div class="container">
          <header class="mb-5">
            ...
            <?php if(isset($_SESSION['contact_success'])){ ?>
              <div class="text-center alert alert-primary">Thank you contact us. Our support team will contact you soon.</div>  
              <p>&nbsp;</p>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul class="list-style-none">
                <li><strong><a href="mailto:">info@zellanto.com</a></strong></li>
                <li><strong><a href="#">
                      Ticketio
      ...
      <section>
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-7">
              <form id="contact-form" method="POST" action="contact_insert.php" class="custom-form">
                <div class="controls">
                  <div class="row">
                    <div class="col-sm-6">
