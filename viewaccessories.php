    ...
    <div class="details-page">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active text-uppercase"><a href="accessories.php" class="text-primary">Accessories</li></a>
          <li class="breadcrumb-item active text-uppercase"><?php echo $_REQUEST['name']; ?>-<?php echo $_REQUEST['Accname']; ?></li>
        </ol>
      </div>
      <!-- Item details -->
      <section class="item-details p-t-small p-b-small">
        <div class="container">
          <?php
          $qry="select * from accessories a,media m,brand b,accessoriesmaster am where a.media_id=m.media_id and a.brand_id=b.brand_id and a.Acc_cat_id=am.acc_cat_id  and Acc_id=".$_REQUEST['aid'];
        ...
        <li class="item5"><a href="#"><img src="images/arrow.png" alt="">Make A Gift</a>
          <ul>
            ...
            <div class="col-md-6">
              <h1 class="h2"><?php echo $lst['name']."-".$lst['acc_name']; ?></h1>
              ...
              <div class="model">
                <ul class="list-unstyled">
                  <li><span class="text-uppercase">Item No: </span><?php echo $lst['name']."-".$lst['acc_name']; ?></li>
              ...
              <form action="#" method="get">
                ...
                <div class="CTAs"> 
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a href="cartsession.php?catid=<?php echo $viewcatid ?>&Acc_id=<?php echo $lst['Acc_id']; ?>&ad_cart=1" class="add-cart item_add" class="btn btn-unique">Add To Cart</a>
                      <a href="cartsession.php?catid=<?php echo $catid ?>&Acc_id=<?php echo $lst['Acc_id']; ?>&buy_now=1" class="add-cart item_add">BUY NOW</a>
                    </li>
                  </ul>
                </div>
              </form>
      ...
      <section class="related-items p-t-small p-b-small">
        <div class="container">
          ...
          <div class="row">
                <?php
                $qry="select * from accessories a,media m,brand b,accessoriesmaster am where a.media_id=m.media_id and a.brand_id=b.brand_id and a.Acc_cat_id=am.acc_cat_id order by Acc_id Desc limit 3";
                $result=mysqli_query($con,$qry);
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-grid5">
                        <div class="product-image5">
                                    ...
                                    <ul class="social">
                                        <li><a href="cartsession.php?catid=<?php echo $viewcatid;?>&Acc_id=<?php echo $lst['Acc_id']; ?>&addcart=1" title="Add to cart" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
